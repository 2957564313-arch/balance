...
#define IMU660RA_ACC_SAMPLE_DEFAULT     ( IMU660RA_ACC_SAMPLE_SGN_4G )          // 在这设置默认的 加速度计 初始化量程
...
void  imu660ra_get_acc_gyro         (void);                                     // 获取 IMU660RA 加速度计和陀螺仪数据

void imu660ra_correct_gyro_offset(int16 gyro_x_offset, int16 gyro_y_offset, int16 gyro_z_offset, int16 deadzone);		  // 校正陀螺仪零偏(含死区与IIR低通滤波)
