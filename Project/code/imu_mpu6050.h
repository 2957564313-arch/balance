...
#define MPU6050_SCL_PIN             (IO_P43 )                                       // 软件 IIC SCL 引脚 连接 MPU6050 的 SCL 引脚
#define MPU6050_SDA_PIN             (IO_P41 )                                       // 软件 IIC SDA 引脚 连接 MPU6050 的 SDA 引脚
//====================================================软件 IIC 驱动====================================================
#else
//====================================================硬件 IIC 驱动====================================================
//#define MPU6050_IIC_SPEED           (暂不支持    )                               // 硬件 IIC 通信速率 最高 400KHz 不建议低于 40KHz
