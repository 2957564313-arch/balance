...
// [Level 1] 根目录 (主菜单)
static MenuNode_t m_task,m_pid, m_track, m_system;

// [Level 2] 任务设置文件夹内的文件
static MenuNode_t s_task_1, s_task_2, s_task_3, s_task_4, s_task_5;
...
void Menu_Init(void) {
    ...
    // Level 1: 主菜单项
	Menu_Set_Item(&m_task,   "1. Task Select ", ITEM_TYPE_MENU, NULL, 0,0,0);
    Menu_Set_Item(&m_pid,    "2. PID Param", 	ITEM_TYPE_MENU, NULL, 0,0,0);
    Menu_Set_Item(&m_track,  "3. Track Set", 	ITEM_TYPE_MENU, NULL, 0,0,0);
    Menu_Set_Item(&m_system, "4. System",    	ITEM_TYPE_MENU, NULL, 0,0,0);
	
	// Level 2: 任务功能
    Menu_Set_Item(&s_task_1,     "Mode_1",ITEM_TYPE_FUNC,  (void*)/*此处放任务1函数*/,        0, 0, 0);
	Menu_Set_Item(&s_task_2,     "Mode_2",ITEM_TYPE_FUNC,  (void*)/*此处放任务2函数*/,        0, 0, 0);
    Menu_Set_Item(&s_task_3,     "Mode_3",ITEM_TYPE_FUNC,  (void*)/*此处放任务3函数*/,        0, 0, 0);
    Menu_Set_Item(&s_task_4,     "Mode_4",ITEM_TYPE_FUNC,  (void*)/*此处放任务4函数*/,        0, 0, 0);
    Menu_Set_Item(&s_task_5,     "Mode_5",ITEM_TYPE_FUNC,  (void*)/*此处放任务5函数*/,        0, 0, 0);
